			...
			<section className={styles.section}>
				...
				<motion.div
					...
					<h1 className={styles.h1}>
						...
						<span className="w-[750px] md:w-[1100px] xl:w-[1250px] 2xl:w-[1500px] z-[-1] absolute top-1/2 left-1/2 __logo-icon-container animate-orbit xl:animate-orbit-slower  transform origin-[80%] [50%] border-2">
							<span className="logo-icon opacity-30">
								<Image
									...
									sizes="70vw"
									loading="lazy"
									className="w-[70vw] md:w-[40vw] xl:w-[30vw] 2xl:w-[15vw]"
								/>
							</span>
						</span>
					</h1>
