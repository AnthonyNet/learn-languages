...
export default function Bottom_Menu({
	...
	return (
		<article className="flex flex-row  w-auto  justify-center">
			<ul className="w-screen max-w-[500px] flex flex-row  items-center justify-around md:border-t-4 border-main cursor-pointer">
				{/* ----------------------
				...
				{pages.map((page, index) => {
					return (
						<li
							className={
								page == currentPage
									? "text-xl border-t border-main rounded-md  sm:w-[50px] text-center mt-2 h-[50px]"
									: page < currentPage - 3
									? "hidden"
