...
const styles = {
    ...
    switch_icon: "fixed top-4 left-2 rounded-full px-5 py-2\ bg-gradient-to-r from-blue-500 to-sky-400 text-black font-semibold tracking-tight ring-2 ring-blue-300/70 shadow-lg transition-all duration-200 hover:translate-y-[1px] hover:shadow-sm hover:brightness-110active:translate-y-[2px]",
};
            ...
            <motion.div
                ...
                {switchSide && (
                    <button onClick={() => [setSwitchLanguage(!switchLanguage)]}>
                        {switchLanguage ? (
                            <p className={styles.switch_icon}>Zkratky</p>
                        ) : (
                            <p
